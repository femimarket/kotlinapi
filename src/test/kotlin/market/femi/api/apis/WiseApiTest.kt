...
import market.femi.api.apis.WiseApi
import market.femi.api.models.Status
import market.femi.api.models.Wise

class WiseApiTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of WiseApi
        //val apiInstance = WiseApi()

        // to test wiseCheck
        should("test wiseCheck") {
            // uncomment below to test wiseCheck
