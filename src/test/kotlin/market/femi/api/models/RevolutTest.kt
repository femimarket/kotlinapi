...
class RevolutTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of Revolut
        //val modelInstance = Revolut()
        ...
        // to test the property `revolutOrderId`
        should("test revolutOrderId") {
            // uncomment below to test the property
            //modelInstance.revolutOrderId shouldBe ("TODO")
        }
